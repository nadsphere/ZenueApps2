...
<nav class="mb-3">
	<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="#">Zenith</a></li>
			<li class="breadcrumb-item"><a href="#">Wedding</a></li>
			<li class="breadcrumb-item active" aria-current="page">Paket Nikah ...</li>
	</ol> 
</nav>
	...
	<div class="row no-gutters">
		<div class="col-sm-6">
			<article class="gallery-wrap"> 
				<div class="img-big-wrap">
					<div> <a href="" data-fancybox=""><img class="img-responsive img-wrap" src="{{ asset('img/items/wedding-master.jpg') }}"></a></div>
				</div>
		...
		<div class="col-sm-6">
			<article class="card-body">
				<!-- short-info-wrap -->
					<h3 class="title mb-3">Paket Nikah Minimalis</h3>
				<div class="mb-3"> 
					<var class="price h3 text-warning"> 
						<span class="currency">Rp 16.500.000</span>
					</var> 
				</div>
				...
				{{-- <div class="row">
					<div class="col-sm-11">
						<h5 style="matgin-bottom:0px"><strong>Description</strong></h5>	
						<p class="text-justify">Here goes description consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
