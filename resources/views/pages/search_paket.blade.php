        ...
        <div class="container">
            ...
            <div class="row">
                <aside class="col-sm-3">
                    <h5><i class="fa fa-filter"></i> <b> Pencarian</b></h5>
                            ...
                            <div class="filter-content collapse show" id="collapse44">
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-5">
                                        <label>Min</label>
                                        <input class="form-control" placeholder="Rp Min" type="number">
                                    </div>
                                    ...
                                    <div class="form-group text-right col-md-5">
                                        <label>Max</label>
                                        <input class="form-control" placeholder="Rp Max" type="number">
                                    </div>
                                    </div> <!-- form-row.// -->
                                    <button class="btn btn-block btn-outline-primary">Terapkan</button>
                                </div> <!-- card-body.// -->
                            </div> <!-- collapse .// -->
                        </article>
                    </div>
                ...
                <main class="col-sm-8">
                    ...
                    <article class="card card-product">
                            <div class="card-body">
                                <div class="row">
                                    <aside class="col-sm-3">
                                        <div class="img-wrap"><img height="200px" alt="gambar nikana" width="200px" src="{{ asset('img/paket/weds.jpg') }}"></div>
                                    </aside> 
                                    <article class="col-sm-8">
                                            ...
                                            <div class="rating-wrap mb-2">
                                                ...
                                                <div class="label-rating"><b> (123)</b></div> 
                                                <br />
                                                <p class="title"> <b>Pak Eko dkk</b></p> 
                                            </div>
                                            ...
                                            <a style="font-size:15pt" href="#" class="float-right"><i class="fa fa-heart"></i></a>
                                    </article>
                                </div> 
                            </div>
                    </article>
