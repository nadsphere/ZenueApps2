  ...
  <div class="container-scroller">
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="home.html"><h3>ZEN</h3></a>
          {{-- <a class="navbar-brand brand-logo" href="home.html"><img src="vends/images/logo.svg" alt="logo"/></a> --}}
          <a class="navbar-brand brand-logo-mini" href="home.html"><img src="vends/images/logo-mini.svg" alt="logo"/></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Data Transact</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="booking.html">Booking</a></li>
                <li class="nav-item"> <a class="nav-link" href="transact.html">Transaksi</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="users">
              <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="eo.html">Event Organizer</a></li>
              </ul>
            </div>
          </li> 
          <li class="nav-item">
            <a class="nav-link" href="paket.html">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center text-center">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2019 <strong>Zenith</strong> All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
