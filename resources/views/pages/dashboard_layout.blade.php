...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>ZENITH</b>REVENUE</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Bookings</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Event Organizers</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Pakets</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Users</a></li>  
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Transactions</a></li>
          </ul>
        </li>
        <li class="treeview">
          <ul class="treeview-menu">
