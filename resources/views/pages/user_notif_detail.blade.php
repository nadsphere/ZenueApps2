@extends('layout.app')
@section('body_class', 'is-user-notif-detail')
@push('styles')
<link rel="stylesheet" href="{{ asset('css/user_notif_detail.css') }}">
@endpush
@section('content')
    <main id="main">
                                ...
                                <article class="col-sm-12 mt-1">
                                        <form action="" class="p-0" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7 col-md-9">
                                                            <textarea name="deskrisi_pkt2" class="form-control-plaintext" name="deskripsi" id="des_pkt2" rows="3" readonly >Acara ini lebih simple </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
