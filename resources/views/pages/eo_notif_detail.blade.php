        ...
        <ul>
          ...
          <li class="dropdown notifications">
              ...
              <ul class="dropdown-menu dropdown-menu-small">
                <li>
                    <a class="dropdown-item" href="/eo/notif">
                        ...
                        <div class="notification__content">
                          ...
                          <p>Pesanan BK001 dari Jono Triyono telah diterima..</p>
                        </div>
                      </a>
                </li>
                <hr>
                ...
                <hr>
                <li>
                    <a class="dropdown-item" href="user_notif.html">
                        <div class="notification__icon-wrapper">
                          <div class="notification__icon">
          ...
          <li class="drop-down"><a href="index.html"><span>Jojo Organizer</span></a>
            <ul>
              <li><a href="eo_editprofile.html">Atur EO</a></li>
                ...
                <div class="col-sm-3">
                    <div class="footer-links">
                        <h4>Lebih Tahu Zenith</h4>
                          <ul>
                            <li><a href="#" class="linku">Tentang Kami</a></li>
