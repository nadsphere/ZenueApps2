        ...
        <div class="container conts">
            <div class="signup-content">
                <form method="POST" id="signup-form" class="form-signin">
                    <h2 class="form-title">Daftar EO</h2>
                    <div class="form-label-group">
                        <input type="text" id="inputNama" class="form-input form-control" placeholder="Nama" required autofocus>
                        <label for="inputNama"><i class="fa fa-user"></i> Nama EO</label>
                    </div>
                    <div class="form-label-group">
                        <input type="email" id="inputEmail" class="form-input form-control" placeholder="Email address" required autofocus>
                        <label for="inputEmail"><i class="fa fa-envelope"></i> Email EO</label>
                    </div>
                    <div class="form-label-group">
                        <input type="text" id="inputNama" class="form-input form-control" placeholder="Nama" required autofocus>
                        <label for="inputNama"><i class="fas fa-map-marker-alt"></i> Alamat</label>
                    </div>
                    <div class="form-label-group">
                        <input type="number" id="inputTelp" class="form-input form-control" placeholder="Nama" required autofocus>
                        <label for="inputTelp"><i class="fas fa-phone"></i> Kontak</label>
                    </div>
                    <div class="form-label-group">
                        <input type="text" id="inputLink" class="form-input form-control" placeholder="Nama" required autofocus>
                        <label for="inputLink"><i class="fas fa-globe"></i> Link</label>
                    </div>
                    <div class="form-label-group">
                        <input type="number" id="inputTelp" class="form-input form-control" placeholder="Nama" required autofocus>
                        <label for="inputTelp"><i class="fas fa-globe"></i> Gambar Profil</label>
                    </div>
