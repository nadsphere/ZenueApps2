                                    ...
                                    <div class="col-12 col-lg-4 col-xl-3 order-2 order-lg-1">
                                            <div class="card mb-4">
                                                <div class="card-body text-center">
                                                    ...
                                                    <hr>
                                                    <p class="text-justify">Jono Organizer menerima Jasa Event MC, singer, make-up, fotografi, dancer, magcian, model, usher, band. Jakarta, Bandung dan luar kota lainnya. BASE DI JAKARTA
                                            ...
                                            <div class="card mb-4">
                                                <a class="link" href="#">
                                                    <div class="card-header">
                                                        ...
                                                        <h5 class="card-title mb-0">Paket</h5>
                                                    </div>
                                                </a>
                                            </div>
                                    </div>
                                                ...
                                                <div class="card-body h-100">
                                                    ...
                                                    <div class="media">
                                                        <div class="media-body">
                                                            ...
                                                            <h3 class="mb-2"><strong>Reviews</strong></h3>
